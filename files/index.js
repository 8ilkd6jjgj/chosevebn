...
const port = process.env.SERVER_PORT || process.env.PORT || 7800;        
const UUID = process.env.UUID || 'ca6caf48-dd55-46e2-92a4-c665e80e675d'; //若需要改UUID，需要在config.json里改为一致
...
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'cho7.gohitravel.cf';     // 建议使用token，argo端口8080，cf后台设置需对应,使用json需上传json和yml文件至files目录
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiMGJiYWFkOTM2YzVlYzEwYjEwMTMyYzI5MGNhZmZlOTUiLCJ0IjoiMmMxYmQyMjQtMTU4MS00ZTVjLTlhOTEtNzBkNTFlNjQ5MDkyIiwicyI6Ik5UWmxZalk1WldRdFpUYzNOeTAwWXpJNExXSTJOV010WlROaU1HSTRNVEpsTjJZNSJ9';
